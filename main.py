...
# Verbose called with host name
# -- multiple ports returned if two servers ar running on localhost with different ports
# scanme.nmap.org was not working
ports = port_scanner.get_open_ports("localhost", [7, 9000], True)
print(ports + '\n')
